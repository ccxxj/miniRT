...
/*   Updated: 2021/05/24 14:56:49 by Xiaojing      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	process_square(t_object *object)
{
	if (object->orientation[1] == 1 || object->orientation[1] == -1)
		exp_handle(object->coordinates_3, object->coordinates_2,
	...
	else
	{
		...
		cross_product(object->orientation, object->coordinates_2,
			object->coordinates_3);
		normalization(object->coordinates_3);
		cross_product(object->coordinates_3, object->orientation,
